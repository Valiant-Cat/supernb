...
Examples:
  ...
  bash <(curl -fsSL https://raw.githubusercontent.com/WayJerry/supernb/main/scripts/install-claude-code-remote.sh) --repo-url https://github.com/WayJerry/supernb.git --project-dir ~/projects/my-app
  bash <(curl -fsSL https://raw.githubusercontent.com/Valiant-Cat/supernb/main/scripts/install-claude-code-remote.sh) --repo-url https://github.com/Valiant-Cat/supernb.git --project-dir ~/projects/my-app
EOF
}
