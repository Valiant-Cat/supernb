...
```bash
python3 -m pip install -r ~/.codex/skills/android-i18n-translation/scripts/requirements_translation.txt
```

## 2) Extract hardcoded layout text to strings

```bash
python3 ~/.codex/skills/android-i18n-translation/scripts/localize_hardcoded_layout_texts.py \
...
python3 ~/.codex/skills/android-i18n-translation/scripts/complete_android_multifile_translations.py \
  --res-dir app/src/main/res \
  --provider openai \
  --model gpt-4o-mini
```
